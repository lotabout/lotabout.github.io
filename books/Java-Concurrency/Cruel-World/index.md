...
在了解三个特征之前，我们先了解了解 CPU 的缓存结构，它对这些特性有很大的影响。

当前 CPU 算力可以说相当强劲，程序的主要的性能瓶颈不在计算，而在数据的读写。根
据 [Latency Numbers Every Programmer Should
...
我们会看到，不管是硬件还是软件上的优化，都在尝试提供缓存的命中率。
